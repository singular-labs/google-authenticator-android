...
public class CheckCodeActivityTest extends ActivityInstrumentationTestCase2<CheckCodeActivity> {
  ...
  public void setUp() throws Exception {
    ...
    accountDb.update(
        "johndoe@gmail.com", "7777777777777777", "johndoe@gmail.com", AccountDb.OtpType.TOTP, null);
    accountDb.update(
        "shadowmorton@aol.com", "2222222222222222", "shadowmorton@aol.com", AccountDb.OtpType.HOTP, null);
    accountDb.update(
        "maryweiss@yahoo.com", "7777777777777777", "maryweiss@yahoo.com", AccountDb.OtpType.HOTP, 0);
