...
import net.singular.authenticator.howitworks.IntroEnterPasswordActivity;
import net.singular.authenticator.testability.DependencyInjector;
import net.singular.authenticator.testability.StartActivityListener;
...
public class AuthenticatorActivityTest extends
  ...
  public void testGetOtpWithOneTotpAccount() throws Throwable {
    mAccountDb.update(
        "johndoeTotp@gmail.com", "7777777777777777", "johndoeTotp@gmail.com", AccountDb.OtpType.TOTP, null);
    ListView userList = (ListView) getActivity().findViewById(R.id.user_list);
  ...
  public void testGetOtpWithOneHotpAccount() throws Throwable {
    mAccountDb.update(
        "johndoeHotp@gmail.com", "7777777777777777", "johndoeHotp@gmail.com", AccountDb.OtpType.HOTP, null);
    ListView userList = (ListView) getActivity().findViewById(R.id.user_list);
    assertEquals(1, userList.getChildCount());
    View listEntry = userList.getChildAt(0);
    String user = ((TextView) listEntry.findViewById(R.id.current_user)).getText().toString();
  ...
  public void testGetOtpWithMultipleAccounts() throws Throwable {
    mAccountDb.update(
        "johndoeHotp@gmail.com", "7777777777777777", "johndoeHotp@gmail.com", AccountDb.OtpType.HOTP, null);
    mAccountDb.update(
        "johndoeTotp1@gmail.com", "2222222222222222", "johndoeTotp1@gmail.com", AccountDb.OtpType.TOTP, null);
    mAccountDb.update(
        "johndoeTotp2@gmail.com", "3333333333333333", "johndoeTotp2@gmail.com", AccountDb.OtpType.TOTP, null);
    ListView userList = (ListView) getActivity().findViewById(R.id.user_list);
