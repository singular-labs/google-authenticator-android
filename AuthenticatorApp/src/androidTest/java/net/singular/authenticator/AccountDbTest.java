...
public class AccountDbTest extends  AndroidTestCase {
  ...
  private void addSomeRecords() {
    accountDb.update("johndoe@gmail.com", SECRET, "johndoe@gmail.com", AccountDb.OtpType.TOTP, null);
    accountDb.update("amywinehouse@aol.com", SECRET2, "amywinehouse@aol.com", AccountDb.OtpType.TOTP, null);
    accountDb.update("maryweiss@yahoo.com", SECRET, "maryweiss@yahoo.com", AccountDb.OtpType.HOTP, 0);
  }
  ...
  public void testGetAndSetType() throws Exception {
    addSomeRecords();
    assertTrue(accountDb.getType("johndoe@gmail.com").equals(AccountDb.OtpType.TOTP));
    assertTrue(accountDb.getType("maryweiss@yahoo.com").equals(AccountDb.OtpType.HOTP));
    assertFalse(accountDb.getType("amywinehouse@aol.com").equals(AccountDb.OtpType.HOTP));
    accountDb.setType("johndoe@gmail.com", AccountDb.OtpType.HOTP);
    assertTrue(accountDb.getType("johndoe@gmail.com").equals(AccountDb.OtpType.HOTP));
    ...
    accountDb.setType("johndoe@gmail.com", AccountDb.OtpType.TOTP);
    assertTrue(accountDb.getType("johndoe@gmail.com").equals(AccountDb.OtpType.TOTP));
  }
  ...
  public void testUpdate() throws Exception {
    ...
    MoreAsserts.assertContentsInAnyOrder(result,
        "johndoe@gmail.com", "amywinehouse@aol.com", "maryweiss@yahoo.com");
    // add new record.
    accountDb.update("johndoenew@gmail.com", SECRET, "johndoe@gmail.com", AccountDb.OtpType.TOTP, null);
    result.clear();
    accountDb.getNames(result);
    MoreAsserts.assertContentsInAnyOrder(result,
        "johndoenew@gmail.com", "amywinehouse@aol.com", "maryweiss@yahoo.com");
    // re-update with the original name
    accountDb.update("johndoe@gmail.com", SECRET, "johndoenew@gmail.com", AccountDb.OtpType.TOTP, null);
    result.clear();
    accountDb.getNames(result);
    MoreAsserts.assertContentsInAnyOrder(result,
        "johndoe@gmail.com", "amywinehouse@aol.com", "maryweiss@yahoo.com");
  ...
  public void testIsGoogleAccount() {
    accountDb.update("1@b.c", SECRET, "1@b.c", AccountDb.OtpType.TOTP, null, true);
    accountDb.update("2@gmail.com", SECRET, "2@gmail.com", AccountDb.OtpType.TOTP, null);
    accountDb.update("3@google.com", SECRET, "3@google.com", AccountDb.OtpType.TOTP, null);
    accountDb.update("4", SECRET, "4", AccountDb.OtpType.HOTP, 3, true);
    accountDb.update("5@yahoo.co.uk", SECRET, "5@yahoo.co.uk", AccountDb.OtpType.TOTP, null);
    accountDb.update("gmail.com", SECRET, "gmail.com", AccountDb.OtpType.TOTP, null);
    accountDb.update(
        "Google Internal 2Factor", SECRET, "Google Internal 2Factor", AccountDb.OtpType.HOTP, null);
  ...
  public void testUpdateWithoutSourceValuePreservesSourceValue() {
    accountDb.update("a@b.c", SECRET, "a@b.c", AccountDb.OtpType.TOTP, null, true);
    accountDb.update("test@gmail.com", SECRET, "test@gmail.com", AccountDb.OtpType.TOTP, null);
    assertTrue(accountDb.isGoogleAccount("a@b.c"));
    assertTrue(accountDb.isGoogleAccount("test@gmail.com"));
    accountDb.update("b@a.c", SECRET, "a@b.c", AccountDb.OtpType.TOTP, null);
    accountDb.update("test@yahoo.com", SECRET, "test@gmail.com", AccountDb.OtpType.TOTP, null);
