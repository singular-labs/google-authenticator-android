...
package net.singular.authenticator.howitworks;

import net.singular.authenticator.AuthenticatorActivity;
import net.singular.authenticator.wizard.WizardPageActivityTestBase;
