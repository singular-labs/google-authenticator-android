...
package net.singular.authenticator.dataimport;
...
import net.singular.authenticator.AccountDb;
...
public class ImporterTest extends AndroidTestCase {
  ...
  public void testImportAccountDb_withAccounts() {
    ...
    assertAccountInDb(account1, "ABCDEFGHI", AccountDb.OtpType.HOTP, 12345);
    assertAccountInDb(account2, "ABCDEF", AccountDb.OtpType.TOTP, 0);
  }

  public void testImportAccountDbDoesNotOverwriteExistingAccounts() {
    String account2 = "a@gmail.com";
    String account1 = "b@gmail.com";
    mAccountDb.update(account1, "AAAAAAAA", account1, AccountDb.OtpType.TOTP, 13);
    Bundle bundle = bundle(
        accountsBundle(
            accountBundle(account1, "ABCDEFGHI", "hotp", 12345),
            accountBundle(account2, "ABCDEF", "totp", null)),
    ...
    assertAccountsInDbInOrder(account1, account2);
    assertAccountInDb(account1, "AAAAAAAA", AccountDb.OtpType.TOTP, 13);
    assertAccountInDb(account2, "ABCDEF", AccountDb.OtpType.TOTP, 0);
  }
  ...
  private void assertAccountInDb(String name, String encodedSecret, AccountDb.OtpType type, int counter) {
